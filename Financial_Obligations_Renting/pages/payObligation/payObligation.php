...
<body id="page-top">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <br>
          <h1 class="h3 mb-2 text-gray-800">Obligaciones pagadas</h1>
          <br>
          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              ...
              <div class="text-center">
                <h4 class="m-0 font-weight-bold text-primary">Obligaciones pagadas</h4>
              </div>
  ...
  <script src="../../js/demo/chart-pie-demo.js"></script> -->
    ...
    <script type="text/javascript" src="js/payObligations.js"></script>
