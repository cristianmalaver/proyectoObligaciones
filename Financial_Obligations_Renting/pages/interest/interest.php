...
<body id="page-top">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <br>
          <h1 class="h3 mb-2 text-gray-800">Consultar Interes</h1>
          <br>
          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              ...
              <div class="text-center">
                <h4 class="m-0 font-weight-bold text-primary">Consulta de interes</h4>
              </div>
              <div class="mx-auto col-md-12">
              <button class="btn btn-primary" type="submit" onclick="convertToExcel(event);return false"><i class="fa fa-download"></i><div class="ripple-container"></div>Click aqui para cargar DTF e IBR</button>
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table  " data-order='[[ 1, "asc" ]]' data-page-length='25' id="tableInterest" width="100%" cellspacing="0">
                </table>
              </div>
            </div>
          </div>
  ...
  <script src="../../js/demo/chart-pie-demo.js"></script> -->
    ...
    <!--<script type="text/javascript" src="../provision/js/provision.js"></script>-->
